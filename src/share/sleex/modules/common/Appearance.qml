...
Singleton {
    ...
    property real backgroundTransparency: Config?.options.appearance.transparency ? Config?.options.appearance.opacity / 100 : 0
    property real contentTransparency: Config?.options.appearance.transparency ? Config?.options.appearance.opacity / 100 : 0
