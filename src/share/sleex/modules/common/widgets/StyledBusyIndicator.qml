...
BusyIndicator {
    ...
    property real implicitSize: Appearance.font.pixelSize.normal * 3
    ...
    component Updater: QtObject {
        ...
        readonly property list<int> expandDelay: [0, 1350, 2700, 4050].map(d => d)
        readonly property list<int> collapseDelay: [667, 2017, 3367, 4717].map(d => d)
