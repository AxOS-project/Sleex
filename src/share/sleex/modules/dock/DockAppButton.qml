    ...
    contentItem: Loader {
        ...
        sourceComponent: Item {
            ...
            RowLayout {
                ...
                Layout.preferredHeight: root.countDotHeight
                Layout.preferredWidth: (appToplevel.toplevels.length <= 3) ? 
                    root.countDotWidth * appToplevel.toplevels.length : root.countDotWidth * 3
                Repeater {
