...
hl.bind("SUPER+Super_L", hl.dsp.global("quickshell:overviewToggleRelease"), { desc = "Shell: Toggle overview/launcher" })
...
hl.bind("SUPER+V", hl.dsp.global("quickshell:overviewClipboardToggle"), { desc = "Shell: Toggle clipboard history" })
hl.bind("SUPER+semicolon", hl.dsp.global("quickshell:overviewEmojiToggle"), { desc = "Shell: Toggle emoji picker" })
hl.bind("SUPER+D", hl.dsp.global("quickshell:dashboardToggle"), { desc = "Shell: Toggle dashboard" })
hl.bind("SUPER+F1", hl.dsp.global("quickshell:cheatsheetToggle"), { desc = "Shell: Toggle cheatsheet" })
hl.bind("CTRL+ALT+Delete", hl.dsp.global("quickshell:sessionToggle"), { desc = "Shell: Toggle session menu" })
hl.bind("SUPER+T", hl.dsp.global("quickshell:wppselectorToggle"), { desc = "Shell: Toggle wallpaper selector" })
...
hl.bind(
	...
	{ locked = true, desc = "Audio: Mute the mic" }
)
hl.bind(
	"XF86AudioMute",
	hl.dsp.exec_cmd("wpctl set-mute @DEFAULT_AUDIO_SINK@ toggle"),
	{ locked = true, desc = "Audio: Mute the sink" }
)
hl.bind(
	"XF86AudioRaiseVolume",
	hl.dsp.exec_cmd("wpctl set-volume -l 1 @DEFAULT_AUDIO_SINK@ 5%+"),
	{ locked = true, repeating = true, desc = "Audio: Increase the volume" }
)
hl.bind(
	"XF86AudioLowerVolume",
	hl.dsp.exec_cmd("wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%-"),
	{ locked = true, repeating = true, desc = "Audio: Decrease the volume" }
)
hl.bind(
	"XF86MonBrightnessUp",
	hl.dsp.exec_cmd("qs -p /usr/share/sleex/ ipc call brightness increment"),
	{ locked = true, repeating = true, desc = "Display: Increase brightness" }
)
hl.bind(
	"XF86MonBrightnessDown",
	hl.dsp.exec_cmd("qs -p /usr/share/sleex/ ipc call brightness decrement"),
	{ locked = true, repeating = true, desc = "Display: Decrease brightness" }
)

------- Terminal and Stuff -------

hl.bind("SUPER", hl.dsp.exec_cmd("true"), { desc = "Shell: Open app launcher" })
hl.bind("CTRL+SUPER+T", hl.dsp.exec_cmd("/usr/share/sleex/scripts/colors/switchwall.sh"), { desc = "Shell: Change wallpaper" })
...
-- on systemd, logind usually intercepts the physical power button natively
-- before this keybind ever fires; disable that with acpid + a custom
-- /etc/acpi/events/power-button-custom entry to let this dialog take over
...
hl.bind("SUPER+Q", hl.dsp.window.close(), { desc = "Window Management: Close an app" })
hl.bind("SUPER+SHIFT+ALT+Q", hl.dsp.exec_cmd("hyprctl kill"), { desc = "Window Management: Pick and kill a window" })

hl.bind("SUPER+ALT+Space", hl.dsp.window.float(), { desc = "Window Management: Toggle floating" })
hl.bind("SUPER+F", hl.dsp.window.fullscreen())

hl.bind("SUPER+mouse:272", hl.dsp.window.drag(), { mouse = true })
hl.bind("SUPER+mouse:273", hl.dsp.window.resize(), { mouse = true })

hl.bind("SUPER+J", hl.dsp.layout("togglesplit"), { desc = "Window Management: Toggle split" })
...
for i = 1, 10 do
	...
	hl.bind(
		...
		{ desc = "Workspace Management: Switch to workspace " .. i }
	)
	hl.bind(
		"SUPER+CTRL+code:" .. code_num,
		hl.dsp.window.move({ workspace = i, follow = false }),
		{ desc = "Workspace Management: Move window to workspace " .. i }
	)
end
...
hl.bind(
	...
	{ locked = true, desc = "Audio: Next track" }
)
hl.bind("XF86AudioPrev", hl.dsp.exec_cmd("playerctl previous"), { locked = true, desc = "Audio: Previous track" })
hl.bind("XF86AudioPlay", hl.dsp.exec_cmd("playerctl play-pause"), { locked = true, desc = "Audio: Play/Pause" })
hl.bind("XF86AudioPause", hl.dsp.exec_cmd("playerctl play-pause"), { locked = true, desc = "Audio: Pause" })